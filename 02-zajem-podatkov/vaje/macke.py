...
csv_filename = 'macki_razpredelnica'
...
def page_to_ads(page_content):
    ...
    vrne njih seznam"""
    exp = r'<div class="coloumn content">(.*?)<div class="clear"></div>'
...
def ads_from_file(filename, directory):
    ...
    return [get_dict_from_ad_block(block).groupdict() for block in ads if get_dict_from_ad_block(block)]
